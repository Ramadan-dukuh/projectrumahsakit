        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="current-data mb-4">
                            <h5 class="text-primary"><i class="bi bi-info-circle me-2"></i>Data Saat Ini</h5>
                            <div class="row mt-3">
                                <div class="col-md-3">
                                    <strong>Kode Ruangan:</strong><br>
                                    <span class="text-dark">{{ $ruangan->kodeRuangan }}</span>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-2">
                                    <strong>Daya Tampung:</strong><br>
                                    <span class="text-dark">{{ $ruangan->dayaTampung }} orang</span>
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <div class="form-section">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="kodeRuangan" name="kodeRuangan" 
                                                value="{{ old('kodeRuangan', $ruangan->kodeRuangan) }}" required placeholder="Masukkan kode ruangan">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="namaRuangan" name="namaRuangan" 
                                                value="{{ old('namaRuangan', $ruangan->namaRuangan) }}" required placeholder="Masukkan nama ruangan">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-section">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="dayaTampung" name="dayaTampung" 
                                                value="{{ old('dayaTampung', $ruangan->dayaTampung) }}" required min="1" placeholder="Jumlah orang">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="lokasi" name="lokasi" 
                                                value="{{ old('lokasi', $ruangan->lokasi) }}" required placeholder="Contoh: Lantai 1, Gedung A">
                ...
                <div class="card mt-4">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="bi bi-eye me-2"></i>Pratinjau Perubahan</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-8">
                                <div id="previewContent">
                                    <p class="text-muted">Perubahan akan muncul setelah formulir diisi</p>
                                </div>
                            </div>
            ...
            function updatePreview() {
                ...
                const previewHTML = `
                    ...
                    <div class="alert alert-info mt-3">
                        <i class="bi bi-lightbulb"></i> Ini adalah pratinjau perubahan yang akan disimpan
                    </div>
                `;
